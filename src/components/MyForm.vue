  ...
  <div class="mx-auto max-w-4xl">
    ...
    <Form :validation-schema="schemaYup" class="px-5" @submit="submit">
      ...
      <div v-if="isEditing">
        ...
        <Field
          :value="todoItem.todo ? todoItem.todo : ''"
        ...
        <label for="time" class="text-m-form-label"
          >When will you do that?</label
        >
        <Field
        ...
        <label for="priority" class="text-m-form-label"
          >How do you priority your to do?</label
        >
        <br />
      ...
      <div class="w-full flex justify-center fixed bottom-6 left-0" as="button">
        ...
        >
          <span v-if="isEditing"> Update Todo </span>
